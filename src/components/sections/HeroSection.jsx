                ...
                <div className='max-w-7xl mx-auto w-full z-10 mt-20'>
                    <div className='block lg:hidden'>
                        ...
                        >
                            ...
                            >
                                <span className=''>Unified DevOps & Full-Stack Engineer</span>
                            </motion.div>
                            <motion.h1
                                variants={itemVariants}
                                className='text-3xl md:text-5xl font-light mb-6 leading-tight'
                            >
                                <span className={`${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Architecting & Developing</span>
                                <span className='text-blue-500 font-medium ml-2'> scalable & high-performance </span>
                                <br/>
                                <span className={`${isDarkMode ? 'text-white' : 'text-gray-900'}`}> user-centric digital systems.</span>
                            </motion.h1>
                            ...
                            >
                                I’m a dedicated full-stack software engineer with expertise in designing and developing
                                scalable solution | system, complemented by hands-on experience in implementing DevOps
                                practices. I focus on delivering high-impact digital solutions by leveraging modern
                                technologies, automation, and continuous integration/continuous deployment (CI/CD)
                                pipelines to ensure reliability and efficiency across the development lifecycle.
                            </motion.p>
                            ...
                            >
                                ...
                                <motion.button
                                    ...
                                    className={`border ${
                                        isDarkMode ? 'border-gray-700 text-gray-300 hover:border-gray-600' : 'border-gray-300 text-gray-700 hover:border-gray-400'
                            ...
                            >
                                {[
                                    ...
                                    <motion.a
                                        ...
                                        className={`p-3 rounded-full transition-colors ${isDarkMode ? 'text-gray-400 hover:text-white' : 'text-gray-600 hover:text-gray-900'}`}
                                    >
                                        <social.icon size={20}/>
                                    </motion.a>
                                ))}
                        ...
                        React
                                ...
                                <span className={isDarkMode ? 'text-gray-700' : 'text-gray-400'}> . </span>
                                <span className={isDarkMode ? 'text-gray-600' : 'text-gray-500'}> ASP.Net </span>
                                <span className={isDarkMode ? 'text-gray-700' : 'text-gray-400'}> . </span>
                                <span className={isDarkMode ? 'text-gray-600' : 'text-gray-500'}> C# </span>
                                <span className={isDarkMode ? 'text-gray-700' : 'text-gray-400'}> . </span>
                                <span
                                    className={isDarkMode ? 'text-gray-600' : 'text-gray-500'}> PostgreSQL | MSSql</span>
                    ...
                    <div className='hidden lg:grid lg:grid-cols-2 lg:gap-16 lg:items-center'>
                        ...
                        >
                            ...
                            >
                                <span className={`${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Architecting & Developing</span>
                                <br/>
                                <span className='text-blue-500 font-medium'> scalable & high-performance </span>
                                <br/>
                                <span className={`${isDarkMode ? 'text-white' : 'text-gray-900'}`}> user-centric digital systems. </span>
                            </motion.h1>
