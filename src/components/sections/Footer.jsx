...
const Footer = () => {
    ...
    //Animated Gradient Line Componnet
  ...
  return (
    ...
    >
        ...
        >
            <div className={`absolute bottom-10 left-1/4 w-64 h-64 rounded-full blur-3xl opacity-3 ${
                isDarkMode
                ...
                >
                    ...
                    <motion.div variants={itemVariants} className='space-y-4'>
                        ...
                        >
                            ...
                            <span>Md Rezaul Hasan</span>
                        </motion.div>
                        <motion.p
                        variants={itemVariants} className={`text-sm ${
                            isDarkMode
                            ? 'text-gray-400'
                            :'text-gray-600'
                        } max-w-md mx-auto`} >
                    ...
                    >
                        {
                            socialLink.map((social,index)=>(
                                ...
                                className={`p-3 rounded-full transition-all duration-300 ${
                                    isDarkMode
                                    ? 'bg-gray-800/50 hover:bg-gray-700/50' :'bg-gray-100/50 hover:bg-gray-200/50'
                    ...
                    <motion.div
                    variants={itemVariants}
                    className='flex items-center justify-content space-x-4'
                    >
                        <div
                    ...
                    >
                        ...
                        whileHover={{
                            ...
                            ? '0 10px 25px rgba(59,130,246,015)'
